 ...
 */
public class LogMgrOrig implements Iterable<BasicLogRecordOrig> {
   /**
    ...
    */
   public LogMgrOrig(String logfile) {
    ...
    */
   public synchronized Iterator<BasicLogRecordOrig> iterator() {
      flush();
      return new LogIteratorOrig(currentblk);
   }
    ...
    */
   	static void printLogPageBuffer(){
	      ...
	      System.out.println("***********************************************************");
	      System.out.println("Log management by Page: ");
	      System.out.println("***********************************************************");
	      byteBuffer = mypage.getContents();
