 ...
 */
class LogIteratorOrig implements Iterator<BasicLogRecordOrig> {
   private Block blk;
    ...
    */
   public BasicLogRecordOrig next() {
      if (currentrec == 0) 
         moveToNextBlock();
      currentrec = pg.getInt(currentrec);
      return new BasicLogRecordOrig(pg, currentrec+INT_SIZE);
   }
